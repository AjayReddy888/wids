...
For all those looking to learn Python from scratch, you can begin with [this notebook]([(https://github.com/kansalmayankkk/WIDS-----OPTIONS-PRICING/blob/main/1%20intro_to_python.ipynb)]), then move to the specific libraries. At the same time, those of you who are already familiar with Python and are just looking to revise can go through [this notebook]((https://github.com/kansalmayankkk/WIDS-----OPTIONS-PRICING/blob/main/2%20Python_review.ipynb)).  
